...
if __name__ == "__main__":
    ...
    def process(path: pathlib.Path):
        ...
        video = render_utils.render_video(gaussian, num_frames=args.num_frames, resolution=args.resolution, r=args.r * biggest_dimension, bg_color=(255, 255, 255))['color']
    ...
    if args.dry:
        ...
        for path in ply_files:
            if args.skip_existing and path.with_suffix('.mp4').exists():
                print(f'Skipping existing {path.with_suffix(".mp4")}')
                continue
